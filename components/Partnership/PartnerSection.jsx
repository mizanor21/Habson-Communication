  ...
  return (
    <div className="bg-white py-10 relative z-[110] rounded-b-[20px] lg:rounded-b-[50px]">
      <div className="p-[5%]">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3  lg:gap-12 items-center text-center  justify-center mt-36">
          {partnersData.map((partner, index) => (
            <div key={index} className="text-center">
              ...
              />
              <h3 className="text-[21px] tracking-tighter font-bold text-black mb-2 mt-10">
                {partner.name}
              </h3>
              <p className="text-black opacity-75 text-[15px] font-semibold mb-2">
                {partner.description}
              </p>
            </div>
          ))}
